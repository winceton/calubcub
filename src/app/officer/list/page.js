...
const page = () => {
  ...
  const fetchStudents = async () => {
    ...
    const { data, error } = await supabase
      .from('students')
      .select('*, values(*), section_id(*, adviser(first_name, middle_name, last_name)), jr_student_grades(*), sr_student_grades(*, subject_id(*))')
      .is('section_id', null)
      .eq('isDeleted', false)
  ...
  return (
    <div className="ml-[6rem] mt-[5rem] p-6 bg-white min-h-[90vh] shadow-lg rounded-lg">
      <Navbar route={"officer"} routeName1={'list'} />
        ...
        <div>
          <div className="flex flex-col lg:flex-row justify-between items-center mb-6">
            <div className='flex flex-col lg:flex-row items-center gap-6'>
              <h1 className="text-2xl font-bold text-[#820000]">Grade</h1>
            ...
            <button
              onClick={() => router.push("/officer/admission/admit")}
                      ...
                      <td className="p-3 text-center relative">
                        ...
                        {openDropdown === student.id && (
                          <div className="absolute right-0 mt-2 w-36 bg-white border border-gray-300 shadow-lg rounded-lg overflow-hidden z-10">
                            <button
                              onClick={() => router.push(`list/student/${student.id}`)}
