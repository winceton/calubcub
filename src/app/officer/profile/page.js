...
const UserProfile = () => {
  ...
  return (
    <div className='ml-[8rem] mt-[5rem] flex items-center gap-16'>
      <NavbarAdmin route={'officer'} routeName1={'Account'} />
      ...
      {user ? (
        <div className="flex lg:flex-row flex-col items-center gap-6 lg:gap-16">
          ...
          <div className="flex flex-col items-center relative">
            ...
            <button onClick={() => setIsPasswordModalOpen(true)} className="absolute -bottom-12 mt-6 text-lg font-bold bg-[#820000] text-white px-3 py-1 rounded-md shadow-md transition-all hover:bg-[#972929]">
              CHANGE PASSWORD
            </button>
          </div>
