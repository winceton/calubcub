...
const Page = () => {
  ...
  const handleClick = (classId, section_name) => {
    router.push(`admission/class/${classId}`)
  }

  return (
    <div className='ml-[6rem] mt-[5rem] bg-gray-50 min-h-auto p-6 rounded-lg shadow-lg'>
      <NavbarAdmin route={'officer'} routeName1={'admission'} />
      ...
      <div className='flex justify-between items-center'>
        ...
        <div className='text-white cursor-pointer py-2 px-4 rounded-lg bg-[#820000] hover:bg-[#6b1919] transition-all text-lg mr-4' onClick={() => router.push('admission/admit')}>Admit Student
        </div>
      </div>
